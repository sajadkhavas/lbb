        ...
        <div className="mx-auto max-w-[860px] px-4 pb-16 md:px-8">
          ...
          <div className="mt-10 space-y-9">
            ...
            <Section title="Web App و اعلان‌های مرورگر">
              ...
              <p>
                در صورت فعال‌سازی و ورود به حساب، مرورگر یک Push Subscription شامل endpoint و کلیدهای
                فنی لازم برای تحویل اعلان ایجاد می‌کند. این اشتراک به حساب همان مشتری متصل می‌شود تا
                اعلان‌های عملیاتی مرتبط با وضعیت واقعی سفارش دریافت شود. مقادیر حساس subscription در
                Backend به‌صورت رمز‌شده نگه‌داری می‌شوند و کلید خصوصی VAPID در Bundle مرورگر قرار
                نمی‌گیرد.
              </p>
              <p>
            ...
            <Section title="فرم تماس و پشتیبانی">
              <p>
                رابط عمومی فقط مسیرهای تماس یا Transportهایی را نمایش می‌دهد که وضعیت آن‌ها در تنظیمات
                و Backend تأیید شده باشد و نباید موفقیت محلی ساختگی نمایش دهد.
              </p>
            ...
            <Section title="کوکی، تحلیل و سرویس‌های جدید">
              <p>
                ...
                پیاده‌سازی تأییدشده‌ای ندارند، ادعای جمع‌آوری یا عدم جمع‌آوری دائمی نمی‌سازد. هر اتصال
                جدید باید همراه با بازبینی این سیاست منتشر شود.
              </p>
              <p>
            ...
            <Section title="تغییرات و اطلاعات تکمیلی">
              <p>
                سیاست نهایی باید نوع داده، هدف پردازش، محل و مدت نگهداری، دریافت‌کنندگان و روش پیگیری
                درخواست‌های مرتبط با داده را بر اساس وضعیت واقعی کسب‌وکار مشخص کند؛ این صفحه جایگزین
                اطلاعاتی که هنوز از مالک فروشگاه تأیید نشده نیست.
              </p>
