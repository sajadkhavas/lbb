      ...
      >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between text-sm">
                ...
                <SizeGuideDialog
                  trigger={
                    <button type="button" className="text-xs text-[var(--lbb-red)]">
                      راهنمای سایز →
                    </button>
                  }
                />
        ...
        <section className="border-t border-black/[0.06]">
          <div className="mx-auto max-w-[1280px] px-4 md:px-8">
            <div className="flex gap-6 overflow-x-auto border-b border-black/[0.06]">
              {(
                [
                  ["desc", "توضیحات"],
                  ["care", "جنس و مراقبت"],
                ...
                <button
                  key={id}
                  onClick={() => setTab(id)}
                  className={`shrink-0 border-b-2 py-3 text-sm ${
              ...
              {tab === "care" && (
                <div className="flex flex-col gap-4">
                  ...
                  <ul className="list-inside list-disc text-gray-600">
                    <li>شست‌وشو با آب سرد و برنامه ملایم</li>
                    <li>عدم استفاده از سفیدکننده و اتوی داغ روی طرح چاپی</li>
                    <li>خشک کردن به‌صورت افقی برای حفظ فرم پارچه</li>
                  </ul>
                </div>
              )}
              {tab === "shipping" && (
                <ul className="flex flex-col gap-2 text-gray-600">
                  ...
                  <li>💳 پرداخت درب منزل در تهران برای برخی محصولات</li>
