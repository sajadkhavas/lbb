          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start lg:gap-14">
            <section>
              ...
              <p className="mt-5 max-w-[64ch] text-sm leading-8 text-metal">
                برای پرسش درباره محصولات، سایز یا همکاری می‌توانید پیام مستقیم ارسال کنید. زمان پاسخ،
                آدرس فیزیکی، شماره تلفن و ایمیل پشتیبانی تا زمانی که به‌صورت رسمی اعلام نشده‌اند در
                این صفحه درج نمی‌شوند.
              </p>
