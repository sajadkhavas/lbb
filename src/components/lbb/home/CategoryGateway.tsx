...
export function CategoryGateway({ liveCategories }: { liveCategories?: StorefrontCategoryDto[] | null }) {
              ...
              {categories.map((category, index) => (
                ...
                >
                  {category.image ? (
                    ...
                    <div className="relative min-h-[270px] bg-[#f3f1ec]" style={{ aspectRatio: "4/3" }}>
