...
export const COLLECTIONS: Collection[] = [
  {
    ...
    metaDesc:
      "دراپ ۰۱ شبگرد از LBB: کالکشن محدود تمام‌مشکی شامل هودی اورسایز، کتونی و اکسسوری. ساخته‌شده برای خیابون‌های تاریک شهر.",
    description:
  ...
  },
  {
    ...
    metaDesc:
      "دراپ ۰۲ آتش سرخ: کالکشنی جسورانه با رنگ قرمز سیگنیچر LBB. تیشرت گرافیک، هودی کلاسیک و اکسسوری قرمز.",
    description:
