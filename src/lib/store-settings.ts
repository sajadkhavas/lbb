...
export const STORE_SETTINGS: StoreSettings = {
  ...
  contacts: [
    ...
    {
      kind: "phone",
      label: "تلفن پشتیبانی LBB",
      value: "026-3256-0477",
      href: "tel:+982632560477",
      isPublic: true,
      verification: "verified",
    },
    {
      kind: "whatsapp",
      label: "واتساپ پشتیبانی LBB",
      value: "0902-858-4879",
    ...
    methods: [
      {
        ...
        description:
          "فقط برای مقصدهای تهران و کرج. هزینه حمل به‌صورت پس‌کرایه و خارج از پرداخت آنلاین فروشگاه دریافت می‌شود.",
        feeToman: null,
        freeFromToman: null,
        processingTimeLabel: null,
        deliveryTimeLabel: "فوری",
        isEnabled: true,
        verification: "verified",
      },
      {
        ...
        description:
          "ارسال به تمام نقاط ایران. هزینه حمل به‌صورت پس‌کرایه و خارج از پرداخت آنلاین فروشگاه دریافت می‌شود.",
        feeToman: null,
        freeFromToman: null,
        processingTimeLabel: null,
        deliveryTimeLabel: "۳ تا ۷ روز",
        isEnabled: true,
        verification: "verified",
      },
      {
  ...
  trustClaims: [
    ...
    },
    {
      ...
      title: "ارسال سفارش",
      description:
        "ارسال فوری با اسنپ/اسنپ‌باکس برای تهران و کرج و ارسال تیپاکس یا دکاپست برای تمام ایران، همگی به‌صورت پس‌کرایه انجام می‌شوند.",
    ...
    },
    {
      ...
      description: "سیاست نهایی تعویض و مرجوعی پس از بازبینی حقوقی منتشر می‌شود.",
      href: "/shipping-returns",
      verification: "pending",
      isEnabled: false,
    },
